...
function RunView() {
    ...
    const copyOutput = () => {
        ...
        toast.success("Clipboard updated with output.")
    }
    ...
    return (
        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                ...
                />
                <button
                    className="flex w-full justify-center rounded-md bg-blue-400 p-2 font-bold text-black outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={runCode}
                    disabled={isRunning}
                >
                    Run
                ...
                <label className="flex w-full justify-between">
                    Output :
                    <button onClick={copyOutput} title="Copy Output" className="hover:bg-darkHover">
                        <LuCopy
                            size={24}
