        ...
        >
            ...
            >
                <div className="flex items-center py-3 text-sm text-gray-800 before:me-6 before:flex-1 before:border-t before:border-gray-200 after:ms-6 after:flex-1 after:border-t after:border-gray-200 dark:text-white dark:before:border-neutral-600 dark:after:border-neutral-600">
                    <span className="ml-2 font-ibm-plex-mono text-lg ">CoDeV</span>
                </div>
                <button
                    className="mt-2 flex w-full justify-start rounded-md p-2  transition-all hover:bg-green-500 "
                ...
                <button
                    className="flex w-full justify-start rounded-md p-2  transition-all hover:bg-green-500 "
                    onClick={downloadFilesAndFolders}
                >
                    <BiArchiveIn className="mr-2" size={24} /> Grab the Code
                    <div className="animate-wiggle mx-2">👋</div>
                </button>
            </div>
        </div>
    )
