...
function FileStructureView() {
    ...
    return (
        <div onClick={handleClickOutside} className="flex flex-grow flex-col mt-2">
            <div className="view-title flex justify-between">
                <h2 className="font-ibm-plex-mono">Folder</h2>
            ...
            <div
                className={cn(
                    "min-h-[200px] flex-grow overflow-auto pr-2 sm:min-h-0 sm:pr-0",
                    {
